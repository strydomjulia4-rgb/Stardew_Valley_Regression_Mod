...
{
    /// <summary>
    /// Localization/data contract loaded from `<lang>.json` files.
    /// Keeps all message templates and content definitions in one typed model.
    /// </summary>
    public class Data
    {
        ...
        public string[] Pee_Toilet_PantsUp;
        ...
        public string[] Poop_Toilet_PantsUp;
